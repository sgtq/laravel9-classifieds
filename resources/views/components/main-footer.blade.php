<footer class="bg-gray-700 text-gray-600 body-font">
    ...
    <div class="bg-gray-100">
        <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p class="text-gray-500 text-sm text-center sm:text-left">© {{ date('Y') }} SauleIT —
                <a href="#" rel="noopener noreferrer" class="text-gray-600 ml-1" target="_blank">BulOnFayer</a>
            </p>
